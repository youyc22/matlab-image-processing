function [re_image,re_info] = decode_find_2(DC_output, AC_output, width,height,QTAB,DCTAB,ACTAB,ratio)
    ...
    for i=1:width*height/ratio
        re_info(i)=re_info_0(i*ratio,end);
    end
